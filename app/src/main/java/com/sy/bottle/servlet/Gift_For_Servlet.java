 ...
 * TODO: 赠送礼物
 */
public class Gift_For_Servlet extends AsyncTask<String, Integer, Base_Entity> {
    ...
    protected Base_Entity doInBackground(String... strings) {
        ...
        map.put("give_user_id", strings[1]);

        String res = HttpUtil.request(HttpUtil.PUT, Const.API + "presents/" + SaveUtils.getString(Save_Key.UID), map);
