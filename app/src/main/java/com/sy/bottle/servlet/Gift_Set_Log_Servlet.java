 ...
 * TODO: 赠送记录
 */
public class Gift_Set_Log_Servlet extends AsyncTask<String, Integer, Gift_Set_Log_Entity> {
    private static final String TAG = "Gift_Log_Servlet";

    Activity activity;

    public Gift_Set_Log_Servlet(Activity activity) {
    ...
    protected Gift_Set_Log_Entity doInBackground(String... strings) {
        ...
        if (TextUtils.isEmpty(res)) {
            ...
            try {
                entity = new Gson().fromJson(res, Gift_Set_Log_Entity.class);
    ...
    @Override
    protected void onPostExecute(Gift_Set_Log_Entity entity) {
        ...
        switch (entity.getStatus()) {
            case 200:
                ...
                if (activity instanceof Log_Activity) {
                    ((Log_Activity) activity).CallBack_Gift_Set(entity.getData());
                }
            ...
            case 400:
                ...
                if (entity.getMessage().equals("无数据")) {
                    ((Log_Activity) activity).CallBack_Gift_Set(null);
                }
                break;
